...
CC_THRESHOLD_QH = 0.15 # Threshold for the coil-to-coil distance penalty in the objective function
...
MAXITER_stage_1 = 50 # Number of iterations to perform in the stage 1 optimization
MAXITER_stage_2_simple = 25 # Number of iterations to perform in the stage 2 optimization (squared flux and length only)
MAXITER_stage_2 = 600 # Number of iterations to perform in the stage 2 optimization
MAXITER_single_stage = 300 # Number of iterations to perform in the main optimization loop
# Flags
...
ftol = 1e-7 # threshold to end optimization
# Stage 2 optimization parameters
coils_objective_weight = 1e+4 # Scale of stage 2 objective with respect to stage 1 objective
...
CS_WEIGHT = 0 #3e-1 # Weight for the coil-to-surface distance penalty in the objective function
